set file_name=python-3.13.14-embed-amd64.zip
set embed_python_url=https://www.python.org/ftp/python/3.13.14/python-3.13.14-embed-amd64.zip
set get_pip_url=https://bootstrap.pypa.io/get-pip.py

set file_pth=python313._pth
set out_7z_name=python-3.13-embed-win64_PySide6.7z
...
python_embed\python.exe -m pip install "PySide6==6.8.3"
...
7z a -t7z -mx=9 "%out_7z_name%" python_embed  qss  JKui  run_Jkui.bat
