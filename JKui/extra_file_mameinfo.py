...
messinfo.dat 格式一样
    https://www.progettosnaps.net/messinfo
...
或
$info=source_id1,source_id2  
    # 目前看都是 单个 game_id 或 单个 source_id
    # 有没有逗号分隔似乎应该没有关系
    # 暂时先不管 ，毕竟其它的文档有 逗号 分隔
$mame 或 $drv
...内容...
$end
...
if __name__ == "__main__":
    ...
    file_name = r"c:\MAME\_code\JKui\dats\mameinfo.dat"
    #file_name = r"c:\MAME\_code\JKui\dats\messinfo.dat"
